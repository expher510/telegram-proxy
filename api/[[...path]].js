export default async function handler(req, res) {
  ...
  // ============================================
  // 2️⃣ استقبال من n8n وإرساله لـ Telegram API (JSON)
  ...
  // ============================================
  // 4️⃣ [جديد] رفع ملف Binary من n8n لـ Telegram
  ...
  return res.status(200).json({
    ...
    endpoints: {
      ...
      upload  : "POST /api/upload?method=sendDocument&chat_id=xxx&filename=data.json&mimetype=application/json", // [جديد]
    },
  });
}
